...
bool is_na (const char *value, const size_t len);

/* Given an array of doubles, return the arithmetic mean value */
long double arithmetic_mean_value (const long double *const values,
                                   const size_t n);
...
*/
long double percentile_value (const long double *const values, const size_t n,
...
long double mad_value (const long double *const values, size_t n,
                       double scale);
...
/*
 ...
 'df' is degrees-of-freedom. Use DF_POPULATION or DF_SAMPLE (see above).
 */
long double covariance_value (const long double *const valuesA,
 ...
 */
long double pearson_corr_value (const long double *const valuesA,
                                const long double *const valuesB, size_t n,
                                int df);
...
/*
 ...
 'df' is degrees-of-freedom. Use DF_POPULATION or DF_SAMPLE (see above).
 */
long double excess_kurtosis_value (const long double *const values, size_t n,
                                   int df);
...
*/
long double dagostino_pearson_omnibus_pvalue (const long double *const values,
                                              size_t n);
 ...
 */
long double mode_value (const long double *const values, size_t n,
                        enum MODETYPE type);

/*
 Given an array of doubles, return the mode/anti-mode values.
 */
long double trimmed_mean_value (const long double *const values, size_t n,
...
bool hash_compare_strings (void const *x, void const *y);
...
size_t guess_file_extension (const char *s, size_t len);
...
long double extract_number (const char *s, size_t len,
                            enum extract_number_type type);
