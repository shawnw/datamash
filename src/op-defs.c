...
const struct processing_mode_definition processing_modes[] = {
  { "invalid", MODE_INVALID },     { "groupby", MODE_GROUPBY },
  { "grouping", MODE_GROUPBY },    { "gb", MODE_GROUPBY },
  { "transpose", MODE_TRANSPOSE }, { "reverse", MODE_REVERSE },
  { "line", MODE_PER_LINE },       { "dedup", MODE_REMOVE_DUPS },
  { "rmdup", MODE_REMOVE_DUPS },   { "nop", MODE_NOOP },
  { "noop", MODE_NOOP },           { "crosstab", MODE_CROSSTAB },
  { "ct", MODE_CROSSTAB },         { "check", MODE_TABULAR_CHECK },
  { NULL, MODE_INVALID },
};
